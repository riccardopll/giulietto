...
test("rotates clockwise seats around each viewer and retains inactive seats", () => {
...
test("shows the remaining bidders without wrapping after the final bidder", () => {
...
test("keeps the trick leader first through wrapped turns and previews the next leader", () => {
  const game = gameFixture();
  game.phase = "playing";
