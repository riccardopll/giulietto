            ...
            {game && !waiting && (
              <div className="relative col-start-2 row-start-1 min-w-0">
                ...
                {game.spectatorCount > 0 && (
                  <span
                    className="absolute left-full top-1/2 ml-1 -translate-y-1/2 min-[360px]:ml-2 inline-flex items-center gap-1 text-xs font-black min-[360px]:text-sm tabular-nums drop-shadow-[0_1px_1px_#30253340]"
                    role="status"
                    aria-label={`${game.spectatorCount} ${game.spectatorCount === 1 ? "spectator" : "spectators"}`}
                  >
                    <span
                      className="text-primary [-webkit-text-stroke:.4px_currentColor]"
                      aria-hidden="true"
                    >
                      {game.spectatorCount}
                    </span>
                    <svg
                      viewBox="0 0 24 18"
                      className="h-3.5 w-4 min-[360px]:h-4 min-[360px]:w-5 text-foreground"
                      aria-hidden="true"
                    >
                      <path
            ...
            {game && (
              <div className="col-start-3 row-start-1 flex items-center justify-self-end">
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-11 w-auto min-w-11 flex-nowrap gap-1 rounded-lg p-0 text-muted-foreground hover:bg-transparent sm:gap-2 sm:px-3"
                  onClick={copy}
