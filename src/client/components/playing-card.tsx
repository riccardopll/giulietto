...
export function PlayingCard({
    ...
    <>
      ...
      {aceMode && (
        <span
          ...
          aria-hidden="true"
        >
          <span className="ace-stamp relative grid h-[56cqw] w-[84cqw] -rotate-6 place-items-center rounded-[50%] bg-parchment p-[2cqw]">
  ...
  const cardClassName = cn(
    "playing-card @container relative isolate block aspect-[5/8] w-full shrink-0 rounded-md border-0 bg-white p-0 shadow-[0_2px_3px,0_7px_14px] shadow-plum/10 select-none",
    onClick &&
