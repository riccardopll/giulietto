...
export function TableSurface() {
  ...
  return (
    <div
      className="pointer-events-none relative -z-1 col-span-full row-start-2 row-end-5 drop-shadow-[0_4px_6px] drop-shadow-foreground/30"
      aria-hidden="true"
    >
      <div
        className="table-felt absolute inset-0 size-full [clip-path:var(--felt-clip)]"
        style={{ "--felt-clip": `url(#${clip})` } as CSSProperties}
      />
      <svg
        fill="none"
